$(function() {
  var InsertLGTMImage, InsertPlusOne, activateExtensions, spinner_image;
  ...
  InsertPlusOne = (function() {
    ...
    InsertPlusOne.prototype.insertButton = function() {
      ...
      $(this.selectors['main_target_form_md_header_ul']).append($icon_node.clone());
      return $(this.selectors['new_note_form_md_header_ul']).append($icon_node.clone());
    };
